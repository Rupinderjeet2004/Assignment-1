    ...
    public class ManufacturersController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var manufacturers = await _context.Manufacturers
                .FirstOrDefaultAsync(m => m.Manufacturer_ID == id);
        ...
        public async Task<IActionResult> Create([Bind("Manufacturer_ID,Manufacturer_Name,WebsiteName,Founded")] Manufacturers manufacturers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Manufacturer_ID,Manufacturer_Name,WebsiteName,Founded")] Manufacturers manufacturers)
        {
            if (id != manufacturers.Manufacturer_ID)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ManufacturersExists(manufacturers.Manufacturer_ID))
                    {
                        return NotFound();
                    }
                    else
